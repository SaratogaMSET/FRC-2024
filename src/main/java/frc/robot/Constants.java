...
public class Constants {
  ...
  public static class Vision {
    ...
    public static final Transform3d jawsCamera0 =
        new Transform3d(
  ...
  public static class Intake { // Waiting for hardware (Akash) with angles to return from Tahoe
    ...
    public static class Shoulder {
      ...
      public static final double MOI =
          Units.inchesToMeters(
              Units.inchesToMeters(Units.lbsToKilograms(421.65))); // lbs sq in -> kg sq m
    ...
    public static class Wrist {
      public static final double ARM_LENGTH =
          Units.inchesToMeters(3.795); // Arbitrary, change me once hardware is finalized
      ...
      public static final double ENCODER_OFFSET_FROM_ZERO =
          0.0; // In degrees from horizontal as zero (for gravity feedforward calculations)
      ...
      public static final double MIN_CURRENT_LIMIT = 17;
  ...
  public static class Elevator {
    ...
    public static final double SOFT_LIMIT_HEIGHT =
        Units.inchesToMeters(31.5 + 10); // max is 1.02235
    ...
    // for below constant: 0.0 (going down all the way) would make this redudant so this is to a
    // constant to help us only go down partway
  ...
  public static class ShooterFlywheelConstants {
    ...
    public static final int kFeederBeamBreakPort = 1; // TODO: CHANGE
    ...
    public static final double height =
        Units.inchesToMeters(24); // TODO: CHANGE ACCORDING TO HARDWARE
    ...
    public static final Pose2d ampside =
        new Pose2d(0.7863951921463013, 6.658573627471924, new Rotation2d(1.0448986674864889));
    public static final Pose2d sourceSide =
        new Pose2d(0.766904354095459, 4.417128086090088, new Rotation2d(-1.0598467586668474));
    ...
    public static final Pose2d bluelineinner328 =
        new Pose2d(5.427524566650391, 6.131943225860596, new Rotation2d(0));
    public static final Pose2d wingmidline =
        new Pose2d(6.302, 7.7695512771606445, new Rotation2d(0.0));
    public static final Pose2d podium = new Pose2d(2.658, 4.125, new Rotation2d(0.0));

    public static final Pose2d feederSource =
        new Pose2d(9.927596092224121, 0.7333604693412781, new Rotation2d(0.0));

    public static final Pose2d sourceAutoEnd =
        new Pose2d(2.4820973873138428, 3.4425861835479736, new Rotation2d(-0.7853981633974483));
  }
  ...
  public static class ShooterPivotConstants {
    ...
    public static final double kEncoderOffset =
        -0.294
            + 200.0 / 360
            - Units.degreesToRotations(58.6 + (58.6 - 47.145))
