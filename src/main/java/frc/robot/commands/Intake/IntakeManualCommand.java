...
public class IntakeManualCommand extends Command {
  ...
  @Override
  public void execute() {
    intake.wrist.setAngle(
        intake.wristGetRads() + wristVelocity * commandScheduleLoopSec, wristVelocity);
    intake.shoulder.setAngle(
        intake.shoulderGetRads() + shoulderVelocity * commandScheduleLoopSec, shoulderVelocity);
  }
