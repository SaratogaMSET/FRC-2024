...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  private double DRIVE_GEAR_RATIO = (50.0 / 14.0) * (17.0 / 28.0) * (45.0 / 15.0);
  ...
  public ModuleIOTalonFX(int index) {
      ...
      case ROBOT_2024P:
        ...
        switch (index) {
          ...
          case 1: //Front Right
            ...
            absoluteEncoderOffset = Rotation2d.fromDegrees(-61.6793+0.21328-2.3); // -61.6793+0.21328
            break;
          case 2: //Back Left
          ...
          case 3: //Back Right
            ...
            absoluteEncoderOffset = Rotation2d.fromDegrees(-107.86406+178.95234+80 - 78.192); // -107.86406+178.95234
            break;
          default:
    ...
    driveConfig.Feedback.SensorToMechanismRatio = (DRIVE_GEAR_RATIO) * ((2 * Math.PI)); // Rotations to radians. 

    driveConfig.Slot0.kS = 0.0;//0.20405 / Module.WHEEL_RADIUS; //0.20405
    driveConfig.Slot0.kV = 0.0;//0.10618 / Module.WHEEL_RADIUS; //0.10618
    driveConfig.Slot0.kA = 0.0;//0.010794 / Module.WHEEL_RADIUS; //0.010794
    driveConfig.Slot0.kP = 0.12 / Module.WHEEL_RADIUS; //0.12 * DRIVE_GEAR_RATIO;
    driveConfig.Slot0.kD = 0.0;

    driveConfig.MotionMagic.MotionMagicCruiseVelocity = (SwerveSubsystem.MAX_LINEAR_SPEED)/Module.WHEEL_RADIUS;
    driveConfig.MotionMagic.MotionMagicAcceleration = 9.8/Module.WHEEL_RADIUS;
    driveConfig.MotionMagic.MotionMagicJerk = 0.0;
  ...
  public void setDriveSetpoint(final double radiansPerSecond) {
    ...
    Logger.recordOutput("Motion Magic Control Desired Velocity", radiansPerSecond);
  }
