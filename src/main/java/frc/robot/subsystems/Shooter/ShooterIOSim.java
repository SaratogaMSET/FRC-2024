...
public class ShooterIOSim implements ShooterIO {
  FlywheelSim shooterSim =
      new FlywheelSim(DCMotor.getFalcon500(2), ShooterFlywheelConstants.kShooterGearing, 0.001);
  // TODO: Check bounds, gearing, etc
  SingleJointedArmSim anglerSim =
  ...
  public void updateInputs(ShooterIOInputs inputs) {
    inputs.shooterRPS =
        new double[] {
          shooterSim.getAngularVelocityRadPerSec(), shooterSim.getAngularVelocityRadPerSec()
        };
