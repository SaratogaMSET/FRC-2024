...
public class ElevatorIOTalonFX implements ElevatorIO {
  ...
  public void updateInputs(ElevatorIOInputs inputs) {
    ...
    inputs.elevatorAppliedVolts =
        new double[] {leftVoltage.getValueAsDouble(), rightVoltage.getValueAsDouble()};
    ...
    inputs.heightLimitTriggered =
        ((inputs.carriagePositionMeters[0] + inputs.carriagePositionMeters[1]) / 2.0)
            >= Elevator.SOFT_LIMIT_HEIGHT;
  }
}
