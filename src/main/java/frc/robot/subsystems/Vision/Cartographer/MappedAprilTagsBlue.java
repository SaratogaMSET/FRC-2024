...
public class MappedAprilTagsBlue {
    ...
    public MappedAprilTagsBlue(){
        ...
        aprilTags.add(new AprilTag( 8, new Pose3d(new Translation3d( -0.024600, 5.559206, 1.451383), new Rotation3d(new Quaternion(0.987391, -0.116575, -0.078912, -0.072396)))));
    }
}