...
public class SuperStructureVisualizer extends SubsystemBase {
  ...
  public SuperStructureVisualizer(
      ...
      DoubleSupplier secondStageLength,
      DoubleSupplier elevatorLength,
      DoubleSupplier shoulderAngle,
    ...
    elevatorLigament =
        mechanismRoot.append(
            new MechanismLigament2d("Elevator", 0.0, 90, 6, new Color8Bit(Color.kBlack)));
    secondStageLigament =
        mechanismRoot.append(
            new MechanismLigament2d("SecondStage", 0.0, 90, 6, new Color8Bit(Color.kGreen)));
    shoulderLigament =
  ...
  public void updateSim() {
    ...
    var carriagePose = new Pose3d(0, 0.0, elevatorLength, new Rotation3d(0.0, 0.0, 0.0));
